# assets.trip.202502081110

Hokkaido, February 2025 — everything the trip's page on
...
```
https://cdn.jsdelivr.net/gh/Zhang-En-Yao/assets.trip.202502081110@<tag>/content.json
```
...
The 70 photographs are in `photos/`, referenced by file name from `content.json`.
